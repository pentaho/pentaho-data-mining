...
public class WekaScoringTest {
  ...
  public static String CLASSIFICATION_MODEL = WekaScoringTest.class.getClassLoader().getResource("nbIris.model").getPath();
  public static String CLUSTERING_MODEL = WekaScoringTest.class.getClassLoader().getResource("emIris.model").getPath();
